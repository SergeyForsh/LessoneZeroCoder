...
text1 = tk.Label(root, text="Введите вашу задачу:", bg="aquamarine1")
text1.pack(pady=5)
task_entry = tk.Entry(root, width=30, bg="RosyBrown1")
...
text2 = tk.Label(root, text="Список задач:", bg="DarkGoldenrod1")
text2.pack(pady=5)
task_listBox = tk.Listbox(root, height=10, width=50, bg="sky blue")
